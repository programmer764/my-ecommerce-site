...
const DesktopFooter = () => {
  return (
    <footer className="bg-gradient-to-r from-blue-200 to-gray-300 text-blue-800 py-4 mt-10">
      <div className="w-full px-4 flex justify-between items-center">
        {/* Логотип */}
        <div className="mb-6 md:mb-0">
          <Link href="/">
            <Image src="/icons/logo.svg" alt="Логотип" width={200} height={100} />
          </Link>
          <p className="text-sm mt-4">&copy; 2025 ClimaTrade. Все права защищены.</p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-1">
            <li><Link href="/warranty"><span className="hover:text-gray-300 hover:underline cursor-pointer">Гарантия</span></Link></li>
            <li><Link href="/about"><span className="hover:text-gray-300 hover:underline cursor-pointer">О компании</span></Link></li>
            <li><Link href="/payment"><span className="hover:text-gray-300 hover:underline cursor-pointer">Оплата и доставка</span></Link></li>
            <li><Link href="/contact"><span className="hover:text-gray-300 hover:underline cursor-pointer">Контакты</span></Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-1">
            <li><Link href="/panel1"><span className="hover:text-gray-300 hover:underline cursor-pointer">Кондиционеры</span></Link></li>
            <li><Link href="/panel2"><span className="hover:text-gray-300 hover:underline cursor-pointer">Радиаторы</span></Link></li>
            <li><Link href="/panel3"><span className="hover:text-gray-300 hover:underline cursor-pointer">Микроклимат</span></Link></li>
            <li><Link href="/panel4"><span className="hover:text-gray-300 hover:underline cursor-pointer">Вентиляция</span></Link></li>
            <li><Link href="/panel5"><span className="hover:text-gray-300 hover:underline cursor-pointer">Осушители</span></Link></li>
            <li><Link href="/panel6"><span className="hover:text-gray-300 hover:underline cursor-pointer">Обогреватели</span></Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-1">
            <li><Link href="/installation"><span className="hover:text-gray-300 hover:underline cursor-pointer">Установка и монтаж</span></Link></li>
            <li><Link href="/approval"><span className="hover:text-gray-300 hover:underline cursor-pointer">Согласование установки</span></Link></li>
            <li><Link href="/service"><span className="hover:text-gray-300 hover:underline cursor-pointer">Сервисное обслуживание</span></Link></li>
          </ul>
        </div>
